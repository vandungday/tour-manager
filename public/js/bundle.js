  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:3000/api/v1/users/update-my-password' : 'http://localhost:3000/api/v1/users/me';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51LN5G7HWg8t6HnQGXstnBTiglHtq5oPuccTJw9Oc3Lakj8UGdrLs5pI4ysqEP2P5vSoN1Eiefy6Lg5mIJvNT9a7M00drB9MeR6');
          _context.prev = 1;
          _context.next = 4;
